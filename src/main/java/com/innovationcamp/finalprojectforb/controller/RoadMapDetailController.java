...
public class RoadMapDetailController {
    ...
    public ResponseDto<?> showRoadmapHtml(@PathVariable Long htmlId,
        ...
        page = page -1;
        return roadMapDetailServercie.showRoadmapHtml(htmlId,page,size);
    }
    ...
    public ResponseDto<?> showRoadmapCss(@PathVariable Long cssId,
                                         ...
                                         @RequestParam("size") int size){
        page = page -1;
        return roadMapDetailServercie.showRoadmapCss(cssId,page,size);
    }
    ...
    public ResponseDto<?> showRoadmapJs(@PathVariable Long jsId,
                                        ...
                                        @RequestParam("size") int size){
        page = page -1;
        return roadMapDetailServercie.showRoadmapJs(jsId,page,size);
    }
    ...
    public ResponseDto<?> showRoadmapReact(@PathVariable Long reactId,
                                           ...
                                           @RequestParam("size") int size){
        page = page -1;
        return roadMapDetailServercie.showRoadmapReact(reactId,page,size);
    }
    ...
    public ResponseDto<?> showRoadmapJava(@PathVariable Long javaId,
                                          ...
                                          @RequestParam("size") int size){
        page = page -1;
        return roadMapDetailServercie.showRoadmapJava(javaId,page,size);
    }
    ...
    public ResponseDto<?> showRoadmapSpring(@PathVariable Long springId,
                                            ...
                                            @RequestParam("size") int size){
        page = page -1;
        return roadMapDetailServercie.showRoadmapSpring(springId,page,size);
    }
}
